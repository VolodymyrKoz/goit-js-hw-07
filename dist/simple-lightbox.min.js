                  ...
                  this.addEventListener(
                    ...
                    function (t) {
                      if (n.isValidLink(t.currentTarget)) {
                        ...
                        (n.initialImageIndex = n.elements.indexOf(
                          t.currentTarget
                        )),
                        ...
                        (n.controlCoordinates.swipeDiff = 0),
                          n.isAnimating && "Escape" === t.key
                            ...
                            : n.isOpen &&
                              ...
                              !n.isAnimating &&
                                -1 <
                                  ["ArrowLeft", "ArrowRight"].indexOf(t.key) &&
                ...
                (e = [
                  ...
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      for (
                        ...
                        l += 1;
                      return (
                        (s += ":nth-child(".concat(l, ")")),
                        ""
                          .concat(this.generateQuerySelector(i), " > ")
                          .concat(s)
                      );
                    },
                  },
                  ...
                  },
                  {
                    ...
                    value: function () {
                      ...
                      i.addEventListener("load", function (t) {
                        ...
                        -1 === e.loadedImages.indexOf(t) &&
                          e.loadedImages.push(t),
                          e.relatedElements[o].dispatchEvent(
                            new Event("nextImageLoaded." + e.eventNamespace)
                          );
                      }),
                        i.setAttribute(
                          "src",
                        ...
                        s.addEventListener("load", function (t) {
                          ...
                          -1 === e.loadedImages.indexOf(t) &&
                            e.loadedImages.push(t),
                            e.relatedElements[o].dispatchEvent(
                              new Event("prevImageLoaded." + e.eventNamespace)
                            );
                        }),
                        s.setAttribute(
                          "src",
                          this.relatedElements[t].getAttribute(
                            this.options.sourceAttr
                          )
                        );
                    },
                  },
                  {
                    ...
                    value: function (t) {
                      ...
                      if (
                        this.isAnimating ||
                        ((t < 0 || t >= this.relatedElements.length) &&
                          !1 === this.options.loop)
                      )
                        return !1;
                      (this.currentImageIndex =
                        t < 0
                          ...
                          : t > this.relatedElements.length - 1
                          ? 0
                          : t),
                    ...
                    value: function (s) {
                      ...
                      t.setAttribute(
                        ...
                        t.addEventListener("error", function (t) {
                          a.relatedElements[a.currentImageIndex].dispatchEvent(
                            new Event("error." + a.eventNamespace)
                          ),
                            (a.isAnimating = !1),
                            (a.isOpen = !0),
                          ...
                          if (a.initialImageIndex === a.currentImageIndex && e)
                            return a.close();
                          a.options.alertError &&
                            alert(a.options.alertErrorMessage),
                            a.loadImage(e ? s : 1);
                        }),
                        t.addEventListener("load", function (t) {
                          void 0 !== s &&
                            (a.relatedElements[
                              ...
                              new Event("changed." + a.eventNamespace)
                            ),
                            a.relatedElements[
                              a.currentImageIndex
                            ].dispatchEvent(
                              new Event(
                                (1 === s ? "nextDone" : "prevDone") +
                                  "." +
                                  a.eventNamespace
                              )
                            )),
                            ...
                            -1 ===
                              a.loadedImages.indexOf(
                                a.currentImage.getAttribute("src")
                              ) &&
                              a.loadedImages.push(
                                a.currentImage.getAttribute("src")
                              );
                          var e,
                            ...
                            i = t.target.width,
                            t = t.target.height;
                          (a.options.scaleImageToRatio || r < i || l < t) &&
                            ((i /= e = r / l < i / t ? i / r : t / l),
                            (t /= e)),
                            (a.domNodes.image.style.top =
                              (window.innerHeight - t) / 2 + "px"),
                            (a.domNodes.image.style.left =
                              (window.innerWidth - i - a.globalScrollbarWidth) /
                                2 +
                              "px"),
                            ...
                            (a.isOpen = !0),
                            "string" == typeof a.options.captionSelector
                              ? (o =
                                  "self" === a.options.captionSelector
                                    ? a.relatedElements[a.currentImageIndex]
                                    : document.querySelector(
                                        a.generateQuerySelector(
                                          a.relatedElements[a.currentImageIndex]
                                        ) +
                                          " " +
                                          a.options.captionSelector
                                      ))
                              : "function" ==
                                  typeof a.options.captionSelector &&
                                (o = a.options.captionSelector(
                                  a.relatedElements[a.currentImageIndex]
                                )),
                            a.options.captions &&
                              o &&
                              (n =
                                "data" === a.options.captionType
                                  ? o.dataset[a.options.captionsData]
                                  : "text" === a.options.captionType
                                  ? o.innerHTML
                                  : o.getAttribute(a.options.captionsData)),
                            a.options.loop
                              ? 1 === a.relatedElements.length
                                ? a.hide(
                                    a.domNodes.navigation.querySelectorAll(
                                      ".sl-prev, .sl-next"
                                    )
                                  )
                                : a.show(
                              ...
                              : (0 === a.currentImageIndex &&
                                  a.hide(
                                    a.domNodes.navigation.querySelector(
                                      ".sl-prev"
                                    )
                                  ),
                                a.currentImageIndex >=
                                  a.relatedElements.length - 1 &&
                                  a.hide(
                                    a.domNodes.navigation.querySelector(
                                      ".sl-next"
                                    )
                            ...
                            1 === s || -1 === s
                              ...
                              : ((a.isAnimating = !1), a.setCaption(n, i)),
                            a.options.additionalHtml &&
                              !a.domNodes.additionalHtml &&
                              ((a.domNodes.additionalHtml =
                                document.createElement("div")),
                              a.domNodes.additionalHtml.classList.add(
                                "sl-additional-html"
                              ),
                              (a.domNodes.additionalHtml.innerHTML =
                                a.options.additionalHtml),
                              a.domNodes.image.appendChild(
                                a.domNodes.additionalHtml
                              )),
                            a.options.download &&
                              a.domNodes.downloadLink.setAttribute(
                                "href",
                                a.currentImage.getAttribute("src")
                              );
                        });
                      ...
                      this.addEventListener(
                          ...
                          this.addEventListener(
                            ...
                            function (t) {
                              if (
                                ...
                                return !0;
                              0 == n.controlCoordinates.containerHeight &&
                                ((n.controlCoordinates.containerHeight =
                                  n.getDimensions(n.domNodes.image).height),
                                (n.controlCoordinates.containerWidth =
                                  n.getDimensions(n.domNodes.image).width),
                                (n.controlCoordinates.imgHeight =
                                  n.getDimensions(n.currentImage).height),
                                (n.controlCoordinates.imgWidth =
                                  n.getDimensions(n.currentImage).width),
                                (n.controlCoordinates.containerOffsetX =
                                  n.domNodes.image.offsetLeft),
                                (n.controlCoordinates.containerOffsetY =
                                  n.domNodes.image.offsetTop),
                                (n.controlCoordinates.initialOffsetX =
                                  parseFloat(
                                    n.currentImage.dataset.translateX
                                  )),
                                (n.controlCoordinates.initialOffsetY =
                                  parseFloat(
                                    n.currentImage.dataset.translateY
                                  )));
                              var e = t.delta || t.wheelDelta,
                                e =
                                  ...
                                  (o = Math.max(
                                    1,
                                    Math.min(n.options.maxZoom, o)
                                  )),
                                  (n.controlCoordinates.targetScale = o),
                                  document.documentElement.scrollTop ||
                                    document.body.scrollTop);
                              (n.controlCoordinates.pinchOffsetX = t.pageX),
                                (n.controlCoordinates.pinchOffsetY =
                                  t.pageY - e || 0),
                                (n.controlCoordinates.limitOffsetX =
                                  (n.controlCoordinates.imgWidth *
                                    n.controlCoordinates.targetScale -
                                    n.controlCoordinates.containerWidth) /
                                  2),
                                (n.controlCoordinates.limitOffsetY =
                                  (n.controlCoordinates.imgHeight *
                                    n.controlCoordinates.targetScale -
                                    n.controlCoordinates.containerHeight) /
                                  2),
                                (n.controlCoordinates.scaleDifference =
                                  n.controlCoordinates.targetScale -
                                  n.controlCoordinates.initialScale),
                                (n.controlCoordinates.targetOffsetX =
                                  n.controlCoordinates.imgWidth *
                                    n.controlCoordinates.targetScale <=
                                  n.controlCoordinates.containerWidth
                                    ? 0
                                    : n.minMax(
                                        n.controlCoordinates.initialOffsetX -
                                          ((n.controlCoordinates.pinchOffsetX -
                                            ...
                                            n.controlCoordinates
                                              .scaleDifference,
                                        -1 * n.controlCoordinates.limitOffsetX,
                                        n.controlCoordinates.limitOffsetX
                                      )),
                                (n.controlCoordinates.targetOffsetY =
                                  n.controlCoordinates.imgHeight *
                                    n.controlCoordinates.targetScale <=
                                  n.controlCoordinates.containerHeight
                                    ? 0
                                    : n.minMax(
                                        n.controlCoordinates.initialOffsetY -
                                          ((n.controlCoordinates.pinchOffsetY -
                                            ...
                                            n.controlCoordinates
                                              .scaleDifference,
                                        -1 * n.controlCoordinates.limitOffsetY,
                                        n.controlCoordinates.limitOffsetY
                                      )),
                                n.zoomPanElement(
                                  n.controlCoordinates.targetOffsetX + "px",
                                  n.controlCoordinates.targetOffsetY + "px",
                                  n.controlCoordinates.targetScale
                                ),
                                1 < n.controlCoordinates.targetScale
                                  ? ((n.controlCoordinates.zoomed = !0),
                                    (!n.domNodes.caption.style.opacity ||
                                      0 < n.domNodes.caption.style.opacity) &&
                                      "none" !==
                                        n.domNodes.caption.style.display &&
                                      n.fadeOut(
                                        n.domNodes.caption,
                                        n.options.fadeSpeed
                                      ))
                                  : (1 === n.controlCoordinates.initialScale &&
                                    ...
                                    (n.controlCoordinates.initialPinchDistance =
                                      null),
                                    (n.controlCoordinates.capture = !1)),
                                (n.controlCoordinates.initialPinchDistance =
                                  n.controlCoordinates.targetPinchDistance),
                                (n.controlCoordinates.initialScale =
                                  n.controlCoordinates.targetScale),
                                (n.controlCoordinates.initialOffsetX =
                                  n.controlCoordinates.targetOffsetX),
                        ...
                        this.addEventListener(
                          ...
                          function (t) {
                            ...
                            if ("mousedown" === t.type)
                              t.preventDefault(),
                                (n.controlCoordinates.initialPointerOffsetX =
                                  t.clientX),
                                (n.controlCoordinates.initialPointerOffsetY =
                                  t.clientY),
                                (n.controlCoordinates.containerHeight =
                                  n.getDimensions(n.domNodes.image).height),
                                (n.controlCoordinates.containerWidth =
                              ...
                              ((n.controlCoordinates.touchCount =
                                t.touches.length),
                              (n.controlCoordinates.initialPointerOffsetX =
                                t.touches[0].clientX),
                              (n.controlCoordinates.initialPointerOffsetY =
                              ...
                              (n.controlCoordinates.containerWidth =
                                n.getDimensions(n.domNodes.image).width),
                              (n.controlCoordinates.imgHeight = n.getDimensions(
                                n.currentImage
                              ).height),
                              (n.controlCoordinates.imgWidth = n.getDimensions(
                                n.currentImage
                              ).width),
                              (n.controlCoordinates.containerOffsetX =
                                n.domNodes.image.offsetLeft),
                              ...
                              if (n.controlCoordinates.doubleTapped)
                                return (
                                  ...
                                  n.controlCoordinates.zoomed
                                    ? ((n.controlCoordinates.initialScale = 1),
                                      n.setZoomData(
                                        n.controlCoordinates.initialScale,
                                        0,
                                        0
                                  ...
                                  setTimeout(function () {
                                    n.currentImage &&
                                      n.currentImage.classList.remove(
                                        "sl-transition"
                                      );
                                  }, 200),
                                  !1
                              ...
                              2 === n.controlCoordinates.touchCount &&
                                ((n.controlCoordinates.initialPointerOffsetX2 =
                                  t.touches[1].clientX),
                                (n.controlCoordinates.initialPointerOffsetY2 =
                                  t.touches[1].clientY),
                                (n.controlCoordinates.initialOffsetX =
                                  parseFloat(
                                    n.currentImage.dataset.translateX
                            ...
                            return (
                              ...
                              !!n.controlCoordinates.mousedown ||
                                (n.transitionCapable &&
                                  (n.controlCoordinates.imageLeft = parseInt(
                                    n.domNodes.image.style.left,
                                    10
                                  )),
                                (n.controlCoordinates.mousedown = !0),
                                (n.controlCoordinates.swipeDiff = 0),
                                (n.controlCoordinates.swipeYDiff = 0),
                                (n.controlCoordinates.swipeStart =
                                  t.pageX || t.touches[0].pageX),
                                (n.controlCoordinates.swipeYStart =
                          ...
                          function (t) {
                            ...
                            if ("touchmove" === t.type) {
                              if (!1 === n.controlCoordinates.capture)
                                return !1;
                              (n.controlCoordinates.pointerOffsetX =
                                t.touches[0].clientX),
                                ...
                                1 < n.controlCoordinates.touchCount
                                  ? ((n.controlCoordinates.pointerOffsetX2 =
                                      t.touches[1].clientX),
                            ...
                            if (
                              ...
                              (n.controlCoordinates.pointerOffsetX = t.clientX),
                                ...
                                Math.abs(n.controlCoordinates.targetOffsetX) ===
                                  Math.abs(n.controlCoordinates.limitOffsetX) &&
                                  ((n.controlCoordinates.initialOffsetX =
                                    n.controlCoordinates.targetOffsetX),
                                  (n.controlCoordinates.initialPointerOffsetX =
                                    n.controlCoordinates.pointerOffsetX)),
                                Math.abs(n.controlCoordinates.targetOffsetY) ===
                                  Math.abs(n.controlCoordinates.limitOffsetY) &&
                                  ((n.controlCoordinates.initialOffsetY =
                                    n.controlCoordinates.targetOffsetY),
                                  (n.controlCoordinates.initialPointerOffsetY =
                                    n.controlCoordinates.pointerOffsetY)),
                            ...
                            n.controlCoordinates.zoomed ||
                              ((n.controlCoordinates.swipeEnd =
                                t.pageX || t.touches[0].pageX),
                              (n.controlCoordinates.swipeYEnd =
                                t.pageY || t.touches[0].pageY),
                              (n.controlCoordinates.swipeDiff =
                                n.controlCoordinates.swipeStart -
                                n.controlCoordinates.swipeEnd),
                              (n.controlCoordinates.swipeYDiff =
                                n.controlCoordinates.swipeYStart -
                                n.controlCoordinates.swipeYEnd),
                              n.options.animationSlide &&
                                n.slide(
                                  0,
                                  -n.controlCoordinates.swipeDiff + "px"
                                ));
                          }
                        ),
                        this.addEventListener(
                          ...
                          function (t) {
                            n.isTouchDevice &&
                              ...
                              ((n.controlCoordinates.touchCount =
                                t.touches.length),
                              0 === n.controlCoordinates.touchCount
                                ? (n.currentImage &&
                                    n.setZoomData(
                                      n.controlCoordinates.initialScale,
                                      n.controlCoordinates.targetOffsetX,
                                ...
                                : 1 < n.controlCoordinates.touchCount &&
                                  (n.controlCoordinates.initialPinchDistance =
                                    null)),
                              n.controlCoordinates.mousedown &&
                                ((t = !(n.controlCoordinates.mousedown = !1)),
                                n.options.loop ||
                                  (0 === n.currentImageIndex &&
                                    n.controlCoordinates.swipeDiff < 0 &&
                                    (t = !1),
                                  n.currentImageIndex >=
                                    n.relatedElements.length - 1 &&
                                    0 < n.controlCoordinates.swipeDiff &&
                                    (t = !1)),
                                Math.abs(n.controlCoordinates.swipeDiff) >
                                  n.options.swipeTolerance && t
                                  ? n.loadImage(
                                      0 < n.controlCoordinates.swipeDiff
                                        ? 1
                                        : -1
                                  ...
                                  : n.options.animationSlide &&
                                    n.slide(
                                      n.options.animationSpeed / 1e3,
                                      "0px"
                                    ),
                                n.options.swipeClose &&
                                  50 <
                                    Math.abs(n.controlCoordinates.swipeYDiff) &&
                                  Math.abs(n.controlCoordinates.swipeDiff) <
                                    n.options.swipeTolerance &&
                                  n.close());
                          }
                        ),
                        this.addEventListener(
                              ...
                              return (
                                ...
                                setTimeout(function () {
                                  n.currentImage &&
                                    ...
                                    (n.currentImage.style[
                                      n.transitionPrefix + "transform-origin"
                                    ] = null));
                                }, 200),
                                !(n.controlCoordinates.capture = !0)
                              );
                    ...
                    value: function (t, e) {
                      ...
                      try {
                        for (n.s(); !(o = n.n()).done; ) {
                          var i = o.value;
                          i.style.display =
                            i.dataset.initialDisplay || e || "block";
                        }
                      } catch (t) {
                        n.e(t);
                      } finally {
